...
<div class="hero">
    ...
    <div class="hero-sub">
        A multi-agent AI system that autonomously researches a topic, scrapes relevant content, drafts a report, and provides feedback.
</div>
...
with col_input:
    ...
    examples = [
        ...
        "AI in Space Exploration: Opportunities and Challenges",
    ]
